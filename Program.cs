...
namespace LinqProject
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            var result=products.Where(p=>p.UnitPrice>5000 && p.UnitsInStock>3); // if kodları ile azdığımız koşul tek sastırda yazmış olduk
        ...
        static List<Product> GetProduct(List<Product> products) // Linq kullanılmadan yazılabilecek metot
        {
